...
def main():
    parser = argparse.ArgumentParser(description="Analyze a soundscape file with a TensorFlow Lite model.")
    ...
    parser.add_argument('--model_path', type=str, default=os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "coreml_export/input/audio-model.tflite"), help='Path to the TensorFlow Lite model.')
    ...
    print(f"Loading TensorFlow Lite model from {args.model_path}")
